...
When IDE agents see `/agentfile:create <name> <description>`:
...
### IDE Execution
```
/agentfile:create security-scanner Create a workflow that analyzes code for security vulnerabilities
```
