...
Input: I need a workflow that analyzes code for security vulnerabilities
```
...
## Example
Input: "Create a workflow that reviews pull requests for code quality, security, and performance issues"
